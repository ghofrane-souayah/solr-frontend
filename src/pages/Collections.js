...
const API = "http://localhost:8081/api/solr/cores";
...
export default function Collections() {
  ...
  if (!/^[A-Za-z0-9._-]+$/.test(coreName) || coreName.startsWith("-")) {
    setErr(
      "Nom invalide. Utilise seulement lettres, chiffres, '.', '_' ou '-', sans espace."
    );
    return;
  }
